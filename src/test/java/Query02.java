...
public class Query02 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
       ...
       System.out.println("Eklenen satir sayisi  " + st.executeUpdate(insertveri));
        ...
        // savas alaninda kahramanlik yapanlari listeleyelim.
      ...
      st.executeUpdate(update1) ;
        ...
        System.out.println("==================================");
        // yili 1915 olan ve kahramanlik alani savas olan kaydi siliniz.
    ...
    git add README.md
        ...
        git branch -M main
        git remote add origin https://github.com/esraunal07/JDBCTeam1088.git
